...
class UnableLoginToStudentOrStaffAccount extends StatefulWidget {
  const UnableLoginToStudentOrStaffAccount({Key? key}) : super(key: key);

  @override
  _UnableLoginToStudentOrStaffAccountState createState() => _UnableLoginToStudentOrStaffAccountState();
}

class _UnableLoginToStudentOrStaffAccountState extends State<UnableLoginToStudentOrStaffAccount> {
              ...
              child: ListView(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Unable to Login to Student or Staff Account',
                      style: TextStyle(
                        fontSize: 24,
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: const Text(
                        '• Incorrect KMUTT login credentials\n'
                            '• Your KMUTT account is suspended\n'
                            '• Maintenance of KMUTT authentication system\n'
                            '• Forgotten student/staff ID or password',
                        style: TextStyle(
                          color: Colors.red,
                          fontSize: 16,
                          height: 1.5,
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            '• Verify your KMUTT username and password\n',
                            style: TextStyle(
                              color: Colors.amber,
                              fontSize: 16,
                              height: 1.2,
                          ...
                          const SizedBox(height: 8),
                          const Text(
                            '• Reset password via KMUTT system\n',
                            style: TextStyle(
                              color: Colors.amber,
                              fontSize: 16,
                              height: 1.3,
